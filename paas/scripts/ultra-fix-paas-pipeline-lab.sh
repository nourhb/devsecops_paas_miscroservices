...
echo "╠══════════════════════════════════════════════════════════════╣"
echo "║  Speed tip (lab): JENKINS_PAAS_FAST_PIPELINE=true → ~1–2h   ║"
echo "║  Full security: false → ~2–4h first run, faster after cache  ║"
echo "║  Console must reach Step 1 in ~30s (not 'Waiting for executor')║"
echo "║  Do NOT restart Jenkins during the build                     ║"
echo "╚══════════════════════════════════════════════════════════════╝"
