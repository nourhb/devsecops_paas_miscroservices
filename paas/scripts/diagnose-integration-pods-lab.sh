...
probe_one "Prometheus" "http://${NODE_IP}:30536/-/healthy"
probe_one "Alertmanager" "http://${NODE_IP}:30772/-/healthy"
probe_one "Vault" "http://${NODE_IP}:31722/v1/sys/health?standbyok=true"
probe_one "Portainer" "http://${NODE_IP}:30777/api/status"
