...
echo "==> 2/4 Sync paas-frontend-env secret + attach envFrom"
PAAS_SKIP_ROLLOUT=0 bash "${SCRIPT_DIR}/sync-paas-frontend-env-k8s.sh"

echo "==> 3/4 Roll out recovery image with lab safety (no container wipe)"
