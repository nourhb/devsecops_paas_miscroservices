#!/usr/bin/env bash
# Commit (optional), pull --rebase, and push ~/gitops using GITOPS_REPO_TOKEN.
# Usage:
#   bash push-gitops-lab.sh                                    # push existing commits only
#   bash push-gitops-lab.sh "chore: blue-green helm templates" # commit apps/ then push
set -euo pipefail
