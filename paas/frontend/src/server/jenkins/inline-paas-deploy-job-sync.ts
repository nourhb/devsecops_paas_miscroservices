...
const PARAMETER_DEFINITIONS: ParamDef[] = [
    ...
    ["JENKINS_NEXT_BUILD_HEARTBEAT", "true", "During npx next build, log a line every HEARTBEAT_SEC (reduces Jenkins exit -2 on long quiet Turbopack); false disables"],
    ["JENKINS_NEXT_BUILD_HEARTBEAT_SEC", "45", "Seconds between next-build heartbeat log lines"],
