...
const envSchema = z.object({
    ...
    JENKINS_DEPLOY_POLL_INTERVAL_MS: z.coerce.number().int().min(1000).default(2500),
    ...
    PAAS_DEPLOY_WAIT_ARGO_MS: z.coerce.number().int().min(10000).default(120000),
    PAAS_DEPLOY_WAIT_HTTP_MS: z.coerce.number().int().min(10000).default(60000),
    PAAS_DEPLOY_HTTP_POLL_MS: z.coerce.number().int().min(1000).default(3000),
    PAAS_DEPLOY_POST_ARGO_PROBE_DELAY_MS: z.coerce.number().int().min(0).default(0),

    PAAS_DEPLOYMENT_STRATEGY: z.enum(["Rolling", "BlueGreen", "rolling", "bluegreen"]).default("Rolling"),
    PAAS_BLUE_GREEN_WAIT_DEPLOY_MS: z.coerce.number().int().min(10000).default(120000),
...
const parsed = envSchema.safeParse({
    ...
    PAAS_DEPLOY_POST_ARGO_PROBE_DELAY_MS: process.env.PAAS_DEPLOY_POST_ARGO_PROBE_DELAY_MS,
