...
const envSchema = z.object({
    ...
    PAAS_DEPLOY_WAIT_ARGO_MS: z.coerce.number().int().min(10000).default(45000),
    PAAS_DEPLOY_WAIT_HTTP_MS: z.coerce.number().int().min(10000).default(30000),
    ...
    PAAS_BLUE_GREEN_WAIT_DEPLOY_MS: z.coerce.number().int().min(10000).default(60000),
